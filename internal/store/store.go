...
//
// The event_id is protected by a unique constraint in PostgreSQL.
// ON CONFLICT makes concurrent duplicate deliveries safe.
...
// AccountStats reads the durable aggregate.
