...
func TestRecordingIsProcessedAfterWebhookReturns(t *testing.T) {
	...
	// Give the asynchronous recording worker enough time to finish.
	// recordingWork is currently 50ms.
